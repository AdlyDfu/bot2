...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6285331067242@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT ✿ADLY KUN✿ JANGAN LUPA SAVE ADLY, PASTI DI SAVEBACK' })
}
