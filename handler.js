...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Perintah ini hanya dapat digunakan oleh _*Adly*_',
        owner: 'Perintah ini hanya dapat digunakan oleh _*Adly*_!',
        mods: 'Perintah ini hanya dapat digunakan oleh _*Moderator*_ !',
        premium: '*Undang Bot+Premium*\n1 Bulan *Rp1.000.000.00*\n2bulan *Rp2.000.000.00*\n\nKetik .sewa kalau minat..', 
        banned: 'Perintah ini hanya untuk pengguna yang terbanned..',
        group: 'Perintah ini hanya dapat digunakan di grub kontol!',
        private: 'Perintah ini hanya dapat digunakan di Chat Pribadi bego!',
